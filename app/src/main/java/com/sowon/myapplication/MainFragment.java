...
/**
 * Created by thdnj on 2017-10-11.
 */
...
public class MainFragment extends AppCompatActivity implements ActionBar.TabListener {
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            ...
            switch(pos) {
                ...
                case 2: return Fragment3.newInstance("ThirdFragment, Instance 1");
                case 3: return Fragment4.newInstance("ThirdFragment, Instance 2");
                default: return Fragment1.newInstance("ThirdFragment, Default");
            }
        }
